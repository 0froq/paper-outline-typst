...
#show: article.with(
  ...
  authors: (
    ...
    (name: "froQ", affiliations: (2, 3), equal-contrib: "These authors contributed equally to this work."),
...
The Introduction section, of referenced text #cite(<woolway2022>) expands on the background of the work (some overlap with the Abstract is acceptable). The introduction should not include subheadings.

Springer Nature does not impose a strict layout as standard however authors are advised to check the individual requirements for the journal they are planning to submit to as there may be journal-level preferences. When preparing your text please also be aware that some stylistic choices are not supported in full text XML (publication version), including coloured font. These will not be replicated in the typeset article if it is accepted.
这是 #annot([一个词], [解释它为什么需要批注]) 的例子。
